...
//rangos de puntos de código Unicode de ancho doble
static dword wideRanges[] =
{
	0x01100, 0x0115F, //hamgul jamo
	0x0231A, 0x0231B, //relojes
	0x02329, 0x0232A, //ángulos
	0x023E9, 0x023EC, //dobles flechas
	0x023F0, 0x023F0, //despertador
	0x023F3, 0x023F3, //reloj de arena
	0x025FD, 0x025FE, //cuadrados
	0x02614, 0x02615, //misceláneos
	0x02648, 0x02653, //misceláneos
	0x0267F, 0x0267F, //misceláneo
	0x02693, 0x02693, //misceláneo
	0x026A1, 0x026A1, //misceláneo
	0x026AA, 0x026AB, //misceláneos
	0x026BD, 0x026BE, //misceláneos
	0x026C4, 0x026C5, //misceláneos
	0x026CE, 0x026CE, //misceláneo
	0x026D4, 0x026D4, //misceláneo
	0x026EA, 0x026EA, //misceláneo
	0x026F2, 0x026F3, //misceláneos
	0x026F5, 0x026F5, //misceláneo
	0x026FA, 0x026FA, //misceláneo
	0x026FD, 0x026FD, //misceláneo
	0x02705, 0x02705, //decoración
	0x0270A, 0x0270B, //decoración
	0x02728, 0x02728, //decoración
	0x0274C, 0x0274C, //decoración
	0x0274E, 0x0274E, //decoración
	0x02753, 0x02755, //decoración
	0x02757, 0x02757, //decoración
	0x02795, 0x02797, //decoración
	0x027B0, 0x027B0, //decoración
	0x027BF, 0x027BF, //decoración
	0x02B1B, 0x02B1C, //misceláneos
	0x02B50, 0x02B50, //misceláneo 
	0x02B55, 0x02B55, //misceláneo
	0x02E80, 0x02E99, //suplemento de radicales CJK
	0x02E9B, 0x02EF3, //suplemento de radicales CJK
	0x02F00, 0x02FD5, //radicales kangxi
	0x02FF0, 0x02FFB, //caracteres de descripción ideográficos
	0x03001, 0x0303E, //símbolos y puntuación CJK
	0x03041, 0x03096, //hiragana
	0x03099, 0x030FF, //hiragana/katakana
	0x03105, 0x0312F, //bopomofo
	0x03131, 0x0318E, //jamo de compatibilidad hangul
	0x03190, 0x031BA, //kanbun, bopomofo extendido
	0x031C0, 0x031E3, //trazos CJK
	0x031F0, 0x0321E, //extensiones fonéticas katakana, letras y meses en círculos
	0x03220, 0x03247, //letras y meses en círculos
	0x03250, 0x04DBF, //letras y meses en círculos, compatibilidad CJK, extensión A de ideogramas unificados CJK
	0x04E00, 0x0A48C, //ideogramas CJK unificados, sílabas yi
	0x0A490, 0x0A4C6, //radicales yi
	0x0A960, 0x0A97C, //extensión A de jamo hangul
	0x0AC00, 0x0D7A3, //sílabas hangul
	0x0F900, 0x0FAFF, //ideogramas de compatibilidad CJK
	0x0FE10, 0x0FE19, //formas verticales de puntuación para ideogramas
	0x0FE30, 0x0FE52, //formas de compatibilidad CJK, variantes de forma pequeñas
	0x0FE54, 0x0FE66, //variantes de forma pequeñas
	0x0FE68, 0x0FE6B, //variantes de forma pequeñas
	0x0FF00, 0x0FF60, //ancho doble (unicode: 0x0FF00..0x0FFEF)
	0x0FFE0, 0x0FFE6, //ancho doble (unicode: 0x0FF00..0x0FFEF)
	0x16FE0, 0x16FE3, //símbolos y puntuación ideográficos
	0x17000, 0x187F7, //tangut
	0x18800, 0x18AF2, //componentes tangut
	0x1B000, 0x1B11E, //suplemento de kana, extensión A de kana
	0x1B150, 0x1B152, //pequeña extensión kana
	0x1B164, 0x1B167, //pequeña extensión kana
	0x1B170, 0x1B2FB, //nushu
	0x1F004, 0x1F004, //pieza de mahjong
	0x1F0CF, 0x1F0CF, //joker negro
	0x1F18E, 0x1F18E, //texto en cuadrado
	0x1F191, 0x1F19A, //texto en cuadrados
	0x1F200, 0x1F202, //suplemento de ideogramas rodeados
	0x1F210, 0x1F23B, //suplemento de ideogramas rodeados
	0x1F240, 0x1F248, //suplemento de ideogramas rodeados
	0x1F250, 0x1F251, //suplemento de ideogramas rodeados
	0x1F260, 0x1F265, //suplemento de ideogramas rodeados
	0x1F300, 0x1F320, //símbolos y pictogramas misceláneos
	0x1F32D, 0x1F335, //símbolos y pictogramas misceláneos
	0x1F337, 0x1F37C, //símbolos y pictogramas misceláneos
	0x1F37E, 0x1F393, //símbolos y pictogramas misceláneos
	0x1F3A0, 0x1F3CA, //símbolos y pictogramas misceláneos
	0x1F3CF, 0x1F3D3, //símbolos y pictogramas misceláneos
	0x1F3E0, 0x1F3F0, //símbolos y pictogramas misceláneos
	0x1F3F4, 0x1F3F4, //símbolos y pictogramas misceláneos
	0x1F3F8, 0x1F43E, //símbolos y pictogramas misceláneos
	0x1F440, 0x1F440, //símbolos y pictogramas misceláneos
	0x1F442, 0x1F4FC, //símbolos y pictogramas misceláneos
	0x1F4FF, 0x1F53D, //símbolos y pictogramas misceláneos
	0x1F54B, 0x1F54E, //símbolos y pictogramas misceláneos
	0x1F550, 0x1F567, //símbolos y pictogramas misceláneos
	0x1F57A, 0x1F57A, //símbolos y pictogramas misceláneos
	0x1F595, 0x1F596, //símbolos y pictogramas misceláneos
	0x1F5A4, 0x1F5A4, //símbolos y pictogramas misceláneos
	0x1F5FB, 0x1F64F, //símbolos y pictogramas misceláneos
	0x1F680, 0x1F6C5, //símbolos de transporte y mapas
	0x1F6CC, 0x1F6CC, //símbolos de transporte y mapas
	0x1F6D0, 0x1F6D2, //símbolos de transporte y mapas
	0x1F6D5, 0x1F6D5, //símbolos de transporte y mapas
	0x1F6EB, 0x1F6EC, //símbolos de transporte y mapas
	0x1F6F4, 0x1F6FA, //símbolos de transporte y mapas
	0x1F7E0, 0x1F7EB, //extensión de formas geométricas
	0x1F90D, 0x1F971, //símbolos y pictogramas suplementarios
	0x1F973, 0x1F976, //símbolos y pictogramas suplementarios
	0x1F97A, 0x1F9A2, //símbolos y pictogramas suplementarios
	0x1F9A5, 0x1F9AA, //símbolos y pictogramas suplementarios
	0x1F9AE, 0x1F9CA, //símbolos y pictogramas suplementarios
	0x1F9CD, 0x1F9FF, //símbolos y pictogramas suplementarios
	0x1FA70, 0x1FA73, //extensión A de símbolos y pictogramas
	0x1FA78, 0x1FA7A, //extensión A de símbolos y pictogramas
	0x1FA80, 0x1FA82, //extensión A de símbolos y pictogramas
	0x1FA90, 0x1FA95, //extensión A de símbolos y pictogramas
	0x20000, 0x2FFFD, //plano ideográfico suplementario
	0x30000, 0x3FFFD, //plano ideográfico terciario
	0
};
