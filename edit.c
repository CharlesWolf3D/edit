...
&Archivo
	...
	&Abrir...                Crtl+O
	&Guardar                 Ctrl+S
	Guardar &como...         Ctrl+Mayus+S
	Guardar copia co&mo...   Ctrl+Alt+S
	&Renombrar...            F2
	Ce&rrar                  Ctrl+F4
	-
	&Salir                   Alt+F4
&Edición
	...
	&Rehacer                 Ctrl+Y
	-
	C&ortar                  Ctrl+X / Mayus+Supr
	&Copiar                  Ctrl+C / Ctrl+Ins
	&Pegar                   Ctrl+V / Mayus+Ins
	&Eliminar                Supr
	-
	Seleccionar &todo        Ctrl+A
	-
	Aumentar sangría         Tab
	Reducir sangría          Mayus+Tab
&Buscar
	&Buscar...               Ctrl+F
	&Siguiente               F3
	&Anterior                Mayus+F3
	S&iguiente seleccionado  Ctrl+F3
	A&nterior seleccionado   Ctrl+Mayus+F3
	Ree&mplazar...           Ctrl+H
&Ver
	&Espacios                Ctrl+Espacio
	&Tabuladores             Ctrl+Mayus+Espacio
	&Nuevas líneas           Ctrl+Intro
	T&odos los caracteres    Ctrl+.
&Configuración
	Preferencias...
	Colores...
Ve&ntana
